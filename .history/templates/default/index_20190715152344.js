...
exports.createApp = function(creater, params, helper, cb) {
  ...
  create.template(
    template,
    'syberospri',
    path.join(platformsDir, syberosDir, 'syberospri'),
    {
      sopid
    }
  )
  ...
  creater.fs.commit(() => {
    ...
    if (typescript) {
      console.log(
        `${chalk.green('✔ ')}${chalk.grey(
          `创建页面 JS 文件: ${projectName}/${src}/index.tsx`
        )}`
      )
    } else {
      console.log(
        `${chalk.green('✔ ')}${chalk.grey(
          `创建页面 JS 文件: ${projectName}/${src}/index.js`
        )}`
      )
    }
    console.log(
      `${chalk.green('✔ ')}${chalk.grey(
        `创建页面 ${currentStyleExt.toLocaleUpperCase()} 文件: ${projectName}/${src}/${pageCSSName}`
      )}`
    )
    if (typescript) {
      console.log(
        `${chalk.green('✔ ')}${chalk.grey(
          `创建文件: ${projectName}/${src}/index.tsx`
        )}`
      )
    } else {
      console.log(
        `${chalk.green('✔ ')}${chalk.grey(
          `创建文件: ${projectName}/${src}/app.js`
        )}`
      )
    }
    ...
    console.log(
      `${chalk.green('✔ ')}${chalk.grey(
        `创建文件: ${projectName}/${src}/${appCSSName}`
      )}`
    )
    console.log(
      `${chalk.green('✔ ')}${chalk.grey(
    ...
    console.log(
      `${chalk.green('✔ ')}${chalk.grey(
        `创建文件: ${projectName}/${platformsDirName}/index.js`
      )}`
    )
